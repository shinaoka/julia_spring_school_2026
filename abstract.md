# Julia Spring School 2026 概要（案）

本ドキュメントは、Julia Spring School 2026（講義 1）の全体構成案をまとめたものです。
最終的には Typst に移植して HTML 公開を行うことを想定し、ここでは章立て（＝題材）とキーメッセージのみを Markdown で記述します。
